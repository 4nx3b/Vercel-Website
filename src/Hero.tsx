      ...
      <div className="relative mx-auto max-w-7xl px-5 pb-16 pt-14 sm:px-8 md:pb-24 md:pt-20">
        <div className="grid items-center gap-14 lg:grid-cols-[1.15fr_0.85fr] lg:gap-10">
          ...
          <Reveal variant="right" delay={300} className="relative">
            ...
            <div className="absolute -right-2 -top-5 hidden rotate-[3deg] border border-lime/40 bg-ink-900/95 px-4 py-2.5 font-mono text-[11px] uppercase tracking-[0.16em] text-lime shadow-lg sm:block">
              ▲ root access granted
            </div>
          </Reveal>
        </div>
